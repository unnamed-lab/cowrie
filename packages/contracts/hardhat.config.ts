...
// Minimal dependency-free .env loader: load packages/contracts/.env into
// process.env (real-world secrets stay out of git; see .env.example).
...
// Precedence: .env / shell env -> hardhat vars -> safe default.
